...
class HomesControllerTest < ActionController::TestCase
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post :create, home: { fecha: @home.fecha, hora: @home.hora, nombre: @home.nombre, telefono: @home.telefono }
    end
  ...
  test "should update home" do
    patch :update, id: @home, home: { fecha: @home.fecha, hora: @home.hora, nombre: @home.nombre, telefono: @home.telefono }
    assert_redirected_to home_path(assigns(:home))
  end
